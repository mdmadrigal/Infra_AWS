...
subnet_id=$(aws ec2 describe-subnets --filters Name=vpc-0f3eb9404f137d70e,Values=$vpc_id Name=availabilityZone,Values=us-east-1a --query "Subnets[0].subnet-04cbb7f7050d5e7c0" --output text)
